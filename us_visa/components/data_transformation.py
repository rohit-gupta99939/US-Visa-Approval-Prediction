...
class DataTransformation:
    ...
    def get_data_transformer_object(self)-> Pipeline:
        """
        """
        logging.info(" Entering get_data_transformer_object method of DataTransformetion class.")

        try:
            logging.info("got numarical cols from schema config")

            numeric_transformer = StandardScaler()
            oh_transformer = OneHotEncoder()
            ordinal_encoder = OrdinalEncoder()

            logging.info("initializing StandardScaler, OneHotEncoder and ordinal encoder")
            ...
            logging.info("Executing get_data_transformer_object method of DataTransformation class")
    ...
    def initiate_data_transformation(self,)-> DataIngestionArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                logging.info("Added company_age column into dataset.")

                drop_cols = self._schema_config['drop_columns'] 
                logging.info("Dropping the columns of training dataset.")
                ...
                logging.info("Added company_age column into test dataset.")

                input_feature_test_df = drop_columns(df=input_feature_test_df,cols=drop_cols)
                logging.info("droping the columns in drop_cols of test dataset")
                ...
                logging.info("Used the preprocessing object to fit transform the train feature")

                input_feature_test_arr = preprocessor.transform(input_feature_test_df)

                logging.info("Used the preprocessing object to transform the test feature")
                logging.info("Applying SMOTEEN on training dataset")
                ...
                logging.info("Applying SMOTEEN on testing dataset")
                ...
                logging.info("Exiting initiate_data_transformation method of data_transformation")
